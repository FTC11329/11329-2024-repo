...
@Autonomous(name = "(WIP) Red Left 5 + 2 S C", group = "(Not Working)")
@Config
public class RedLeft5SC extends OpMode {
    boolean whiteLeft;
    boolean hasTwo;
    ...
    static Vector2d placePositionThree = new Vector2d(52, -39);
    ...
    public void start() {
        ...
        Vector2d finalPlaceLocation2 = new Vector2d(56, -7);
        ...
        drivetrain.followTrajectorySequenceAsync(drivetrain
                ...
                .lineToLinearHeading(new Pose2d(pickupSpecial2.getX(), pickupSpecial2.getY() - 5, Math.toRadians(180)))
                .addTemporalMarkerOffset(0, () -> {
                    specialIntake.setIntakeServo(Constants.SpecialIntake.down5);
                })
                .addTemporalMarkerOffset(-1.5, () -> {
                ...
                .lineTo(finalPlaceLocation2.plus(new Vector2d(0,-6)))
                .addTemporalMarkerOffset(-1.5, () -> {
                    outtake.presetArm(Constants.Arm.armMax);
                })
