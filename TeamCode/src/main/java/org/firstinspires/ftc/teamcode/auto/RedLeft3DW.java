...
public class RedLeft3DW extends OpMode {
    ...
    static Vector2d placePositionThree = new Vector2d(52.5, -41.25);
    ...
    public void init() {
        ...
        placeSpikeMark1 = drivetrain.trajectorySequenceBuilder(startingPose)
                ...
                .lineToLinearHeading(new Pose2d(-60.5, -22, Math.toRadians(180)))
                .addTemporalMarker(() -> {
    ...
    public void start() {
        ...
        drivetrain.followTrajectorySequenceAsync(drivetrain
                ...
                .splineTo(new Vector2d(16, -55), Math.toRadians(0))
